    ...
    private void SignUpBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpBtnActionPerformed
        ...
        try {
            ...
            if("".equals(fname.getText())){
                JOptionPane.showMessageDialog(new JFrame(), "Es necesario colocar tu nombre", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }else if("".equals(emailAddress.getText())){
                JOptionPane.showMessageDialog(new JFrame(), "Es necesario tu email", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }else if("".equals(pass.getText())){
                JOptionPane.showMessageDialog(new JFrame(), "Es necesario tu ", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }else {
            ...
            pass.setText("");
            showMessageDialog(null, "Cuenta creada exitosamente!");
            }
        }catch(Exception e){
